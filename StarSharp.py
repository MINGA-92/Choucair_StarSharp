	...
	def AgendamientoReunion():
		try:
			...
			try:
				...
				try:
					driver.find_element(By.XPATH, '//*[@id="Serenity_Pro_Meeting_MeetingDialog10_StartDate"]').clear()
				except:
				...
				print("Seleccionado Por: ", Selector)
				if Selector == "Xpath":
				...
				try:
					driver.find_element(By.XPATH, '//*[@id="Serenity_Pro_Meeting_MeetingDialog10_EndDate"]').clear()
				except:
					pyautogui.press('backspace')
					pyautogui.press('backspace')
					pyautogui.press('backspace')
				...
				print("Seleccionado Por: ", SelectorEnd)
				...
				try:
					#Selector con Xpath
					WebDriverWait(driver, 11).until(EC.visibility_of_element_located((By.XPATH,'//*[@id="select2-result-label-68"]')))
					driver.find_element(By.XPATH, '//*[@id="select2-result-label-68"]').click()
					time.sleep(2)
				except:
					try:
						#Selector con FullXpath
						...
						#Selector con ID
						WebDriverWait(driver, 11).until(EC.visibility_of_element_located((By.ID,'select2-result-label-68')))
						driver.find_element(By.ID,'select2-result-label-68').click()
					time.sleep(2)
...
Reporte(tetsRunner= HtmlTestRunner.HTMLTestRunner(output='ReporteResultados.html'))
